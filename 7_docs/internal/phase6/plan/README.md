...
| **RES-009 Legacy Meter Cleanup Preview Only** | **候选中（preview-only implementation pending; cleanup execution not started）** | [SPEC-LEGACY-METER-CLEANUP-PREVIEW-009.md](../../../../docs/spec/SPEC-LEGACY-METER-CLEANUP-PREVIEW-009.md) |
