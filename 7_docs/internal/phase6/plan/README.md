...
| **RES-019 Legacy Meter Cleanup Execution** | **冻结（cleanup execution not started; no delete/move/compress/truncate; RES-018 validation does not authorize cleanup）** | — |
