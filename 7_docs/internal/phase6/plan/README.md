...
| Desktop Beta17 Structured Compile v2 Release | **已收口 ✓（SC-015..019 complete; local install + cloud download path verified）** | [OmniMemora_Desktop_Beta17_Structured_Compile_v2_Release_Closeout_2026-05-13.md](./OmniMemora_Desktop_Beta17_Structured_Compile_v2_Release_Closeout_2026-05-13.md) |
