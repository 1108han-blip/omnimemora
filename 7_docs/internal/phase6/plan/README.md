...
| **RES-012 Backup Export Dry-Run Preview / Non-Destructive Planning** | **候选中（dry-run preview implementation pending; backup export execution not started; cleanup execution not started）** | [SPEC-LEGACY-METER-BACKUP-EXPORT-DRY-RUN-012.md](../../../../docs/spec/SPEC-LEGACY-METER-BACKUP-EXPORT-DRY-RUN-012.md) |
