...
def _record_compile_event(
    ...
    try:
        ...
        row = {
            ...
            "structured_compile_latency_ms": compile_meta.get("structured_compile_latency_ms"),
            "deadline_profile": compile_meta.get("deadline_profile"),
            "deadline_profile_applied": compile_meta.get("deadline_profile_applied"),
            "client_deadline_seconds": compile_meta.get("client_deadline_seconds"),
            "compile_budget_ms": compile_meta.get("compile_budget_ms"),
            "deadline_budget_exceeded": compile_meta.get("deadline_budget_exceeded"),
            "protect_latest_tool_result": compile_meta.get("protect_latest_tool_result"),
            "max_tool_result_chars": compile_meta.get("max_tool_result_chars"),
