...
MAX_FILE_SIZE_MB = int(os.getenv("OMNIMEMORA_TRACE_EVENTS_MAX_MB", "10"))
RETENTION_DAYS = int(os.getenv("OMNIMEMORA_TRACE_EVENTS_RETENTION_DAYS", os.getenv("OMNIMEMORA_INTERNAL_LOG_RETENTION_DAYS", "7")))
MAX_RECENT_READ_LINES = int(os.getenv("OMNIMEMORA_TRACE_EVENTS_MAX_READ_LINES", "1000"))
