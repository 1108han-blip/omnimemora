"""Tenant-scoped verify wrapper backed by the shared context tool kernel."""
...
from ov_enterprise_context_tool_kernel import context_verify


def main() -> int:
    parser = argparse.ArgumentParser(description="OpenViking tenant verify")
