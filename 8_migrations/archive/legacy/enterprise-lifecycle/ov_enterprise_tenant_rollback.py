"""Tenant-scoped rollback wrapper backed by the shared context snapshot kernel."""
...
from ov_enterprise_context_snapshot_kernel import context_rollback


def main() -> int:
    parser = argparse.ArgumentParser(description="OpenViking tenant rollback")
    parser.add_argument("--tenant", required=True)
    parser.add_argument("--to", default="last-known-good")
